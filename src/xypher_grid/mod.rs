...
fn get_formatted_table(prefix: &str, params: &[usize]) -> Result<Vec<u8>> {
    let name = format!(
        "{}{}",
        prefix,
        params.iter().map(|p| format!("_{}", p)).collect::<String>()
    );
    get_table(&name)
}
...
fn add_precomputed_tables(tables: &mut HashMap<String, Vec<u8>>) {
    ...
    let gen_7_3_data: [u8; 10] = [0x01, 0x00, 0x1e, 0x00, 0xd8, 0x00, 0xe7, 0x00, 0x74, 0x00];
    tables.insert("gen_7_3".to_string(), gen_7_3_data.to_vec());

    // Table gen_7_5 (6 bytes)
    let gen_7_5_data: [u8; 6] = [0x01, 0x00, 0x06, 0x00, 0x08, 0x00];
    tables.insert("gen_7_5".to_string(), gen_7_5_data.to_vec());

    // Table gen_15_1 (30 bytes)
    let gen_15_1_data: [u8; 30] = [
        0x01, 0x00, 0x1c, 0x00, 0xd8, 0x00, 0xb7, 0x00, 0x14, 0x00, 0x64, 0x00, 0x2e, 0x00, 0x24,
        0x00, 0x4d, 0x00, 0x24, 0x00, 0xaf, 0x00, 0x2b, 0x00, 0xbc, 0x00, 0x9c, 0x00, 0x1a, 0x00,
    ];
    tables.insert("gen_15_1".to_string(), gen_15_1_data.to_vec());

    // Table gen_15_3 (26 bytes)
    let gen_15_3_data: [u8; 26] = [
        0x01, 0x00, 0x88, 0x00, 0xc1, 0x00, 0x22, 0x00, 0x33, 0x00, 0x82, 0x00, 0x93, 0x00, 0xa7,
        0x00, 0xaa, 0x00, 0x84, 0x00, 0xaf, 0x00, 0xfc, 0x00, 0x78, 0x00,
    ];
    tables.insert("gen_15_3".to_string(), gen_15_3_data.to_vec());

    // Table gen_15_5 (22 bytes)
    let gen_15_5_data: [u8; 22] = [
        0x01, 0x00, 0xad, 0x00, 0x2f, 0x00, 0x8c, 0x00, 0xbe, 0x00, 0xc5, 0x00, 0x1e, 0x00, 0xbc,
        0x00, 0x44, 0x00, 0xd4, 0x00, 0xa0, 0x00,
    ];
    tables.insert("gen_15_5".to_string(), gen_15_5_data.to_vec());

    // Table gen_15_7 (18 bytes)
    let gen_15_7_data: [u8; 18] = [
        0x01, 0x00, 0xe3, 0x00, 0x2c, 0x00, 0xb2, 0x00, 0x47, 0x00, 0xac, 0x00, 0x08, 0x00, 0xe0,
        0x00, 0x25, 0x00,
    ];
    ...
    let gen_15_11_data: [u8; 10] = [0x01, 0x00, 0x1e, 0x00, 0xd8, 0x00, 0xe7, 0x00, 0x74, 0x00];
    tables.insert("gen_15_11".to_string(), gen_15_11_data.to_vec());

    // Table gen_15_13 (6 bytes)
    let gen_15_13_data: [u8; 6] = [0x01, 0x00, 0x06, 0x00, 0x08, 0x00];
    tables.insert("gen_15_13".to_string(), gen_15_13_data.to_vec());

    // Table gen_31_1 (62 bytes)
    let gen_31_1_data: [u8; 62] = [
        0x01, 0x00, 0xb5, 0x00, 0xff, 0x00, 0x52, 0x00, 0xe4, 0x00, 0x45, 0x00, 0x4a, 0x00, 0x6e,
        0x00, 0xae, 0x00, 0xd2, 0x00, 0x69, 0x00, 0x76, 0x00, 0x43, 0x00, 0xad, 0x00, 0x67, 0x00,
        0x8b, 0x00, 0x15, 0x00, 0xd2, 0x00, 0x41, 0x00, 0xe9, 0x00, 0xf2, 0x00, 0xe9, 0x00, 0x49,
        0x00, 0x4b, 0x00, 0x6f, 0x00, 0x75, 0x00, 0xb0, 0x00, 0x74, 0x00, 0x99, 0x00, 0x45, 0x00,
        0x59, 0x00,
    ];
    ...
    let gen_31_3_data: [u8; 58] = [
        0x01, 0x00, 0xe5, 0x00, 0x24, 0x00, 0xe0, 0x00, 0xd0, 0x00, 0x7a, 0x00, 0x2c, 0x00, 0x7c,
        0x00, 0xa5, 0x00, 0x93, 0x00, 0x1c, 0x00, 0x53, 0x00, 0x73, 0x00, 0x2b, 0x00, 0xd4, 0x00,
        0x83, 0x00, 0x9b, 0x00, 0x94, 0x00, 0x6f, 0x00, 0x3a, 0x00, 0x68, 0x00, 0xa1, 0x00, 0x9b,
        0x00, 0xeb, 0x00, 0x54, 0x00, 0xcd, 0x00, 0xa1, 0x00, 0x25, 0x00, 0xaa, 0x00,
    ];
    tables.insert("gen_31_3".to_string(), gen_31_3_data.to_vec());

    // Table gen_31_5 (54 bytes)
    let gen_31_5_data: [u8; 54] = [
        0x01, 0x00, 0xf1, 0x00, 0xcc, 0x00, 0xd1, 0x00, 0x40, 0x00, 0xd0, 0x00, 0xa5, 0x00, 0x33,
        0x00, 0x03, 0x00, 0x39, 0x00, 0xb2, 0x00, 0xec, 0x00, 0x6a, 0x00, 0xab, 0x00, 0xc2, 0x00,
        0xe3, 0x00, 0x4a, 0x00, 0x80, 0x00, 0xe6, 0x00, 0x9d, 0x00, 0xec, 0x00, 0x2f, 0x00, 0x36,
        0x00, 0xe3, 0x00, 0xe5, 0x00, 0x7d, 0x00, 0xd9, 0x00,
    ];
    tables.insert("gen_31_5".to_string(), gen_31_5_data.to_vec());

    // Table gen_31_7 (50 bytes)
    let gen_31_7_data: [u8; 50] = [
        0x01, 0x00, 0xf4, 0x00, 0xc5, 0x00, 0x21, 0x00, 0x14, 0x00, 0xc3, 0x00, 0xc5, 0x00, 0x08,
        0x00, 0xda, 0x00, 0xfc, 0x00, 0xae, 0x00, 0x96, 0x00, 0xc6, 0x00, 0xa7, 0x00, 0x2c, 0x00,
        0x7d, 0x00, 0xfb, 0x00, 0x85, 0x00, 0x2d, 0x00, 0x4f, 0x00, 0xad, 0x00, 0xd0, 0x00, 0xc7,
        0x00, 0x6c, 0x00, 0xc1, 0x00,
    ];
    tables.insert("gen_31_7".to_string(), gen_31_7_data.to_vec());

    // Table gen_31_9 (46 bytes)
    let gen_31_9_data: [u8; 46] = [
        0x01, 0x00, 0xb2, 0x00, 0xf6, 0x00, 0x6c, 0x00, 0xcf, 0x00, 0x43, 0x00, 0xcb, 0x00, 0x75,
        0x00, 0xed, 0x00, 0xf4, 0x00, 0xa1, 0x00, 0xb2, 0x00, 0xb1, 0x00, 0x75, 0x00, 0x6e, 0x00,
        0x1f, 0x00, 0xd9, 0x00, 0xcb, 0x00, 0x49, 0x00, 0x4b, 0x00, 0x33, 0x00, 0x6e, 0x00, 0x47,
        0x00,
    ];
    ...
    let gen_31_11_data: [u8; 42] = [
        0x01, 0x00, 0x2d, 0x00, 0xde, 0x00, 0xd3, 0x00, 0x50, 0x00, 0x61, 0x00, 0xe5, 0x00, 0x27,
        0x00, 0x64, 0x00, 0xb2, 0x00, 0xae, 0x00, 0xf7, 0x00, 0x8b, 0x00, 0xd9, 0x00, 0x47, 0x00,
        0xb3, 0x00, 0x96, 0x00, 0x7a, 0x00, 0xf4, 0x00, 0xa6, 0x00, 0x59, 0x00,
    ];
    tables.insert("gen_31_11".to_string(), gen_31_11_data.to_vec());

    // Table gen_31_13 (38 bytes)
    let gen_31_13_data: [u8; 38] = [
        0x01, 0x00, 0xc3, 0x00, 0xcb, 0x00, 0xd1, 0x00, 0x43, 0x00, 0x57, 0x00, 0x88, 0x00, 0x33,
        0x00, 0xab, 0x00, 0xfe, 0x00, 0x8d, 0x00, 0x63, 0x00, 0xe6, 0x00, 0x74, 0x00, 0x19, 0x00,
        0xb4, 0x00, 0x3e, 0x00, 0x1f, 0x00, 0xb3, 0x00,
    ];
    tables.insert("gen_31_13".to_string(), gen_31_13_data.to_vec());

    // Table gen_31_15 (34 bytes)
    let gen_31_15_data: [u8; 34] = [
        0x01, 0x00, 0x76, 0x00, 0x34, 0x00, 0x67, 0x00, 0x1f, 0x00, 0x68, 0x00, 0x7e, 0x00, 0xbb,
        0x00, 0xe8, 0x00, 0x11, 0x00, 0x38, 0x00, 0xb7, 0x00, 0x31, 0x00, 0x64, 0x00, 0x51, 0x00,
        0x2c, 0x00, 0x4f, 0x00,
    ];
    ...
    let gen_31_27_data: [u8; 10] = [0x01, 0x00, 0x1e, 0x00, 0xd8, 0x00, 0xe7, 0x00, 0x74, 0x00];
    tables.insert("gen_31_27".to_string(), gen_31_27_data.to_vec());

    // Table gen_31_29 (6 bytes)
    let gen_31_29_data: [u8; 6] = [0x01, 0x00, 0x06, 0x00, 0x08, 0x00];
    ...
    let gen_63_15_data: [u8; 98] = [
        0x01, 0x00, 0x7a, 0x00, 0x0c, 0x00, 0x0e, 0x00, 0xda, 0x00, 0xc3, 0x00, 0x49, 0x00, 0xc2,
        0x00, 0x9d, 0x00, 0x20, 0x00, 0x11, 0x00, 0x05, 0x00, 0x3e, 0x00, 0x47, 0x00, 0x0f, 0x00,
        0x19, 0x00, 0xf0, 0x00, 0xa1, 0x00, 0x15, 0x00, 0xda, 0x00, 0x94, 0x00, 0xb0, 0x00, 0x6d,
        0x00, 0xb7, 0x00, 0x95, 0x00, 0xa6, 0x00, 0xf5, 0x00, 0xda, 0x00, 0xfb, 0x00, 0x97, 0x00,
        0x96, 0x00, 0xaa, 0x00, 0xc3, 0x00, 0x97, 0x00, 0xa0, 0x00, 0x0c, 0x00, 0x82, 0x00, 0xdb,
        0x00, 0x75, 0x00, 0xf4, 0x00, 0x0a, 0x00, 0xa9, 0x00, 0x13, 0x00, 0xcc, 0x00, 0x71, 0x00,
        0x51, 0x00, 0xd6, 0x00, 0xe7, 0x00, 0xe4, 0x00,
    ];
    tables.insert("gen_63_15".to_string(), gen_63_15_data.to_vec());

    // Table gen_63_17 (94 bytes)
    let gen_63_17_data: [u8; 94] = [
        0x01, 0x00, 0x1f, 0x00, 0xd9, 0x00, 0xa3, 0x00, 0xf8, 0x00, 0x08, 0x00, 0xf4, 0x00, 0xa2,
        0x00, 0xc5, 0x00, 0xc8, 0x00, 0xbd, 0x00, 0x11, 0x00, 0x98, 0x00, 0xc2, 0x00, 0xcc, 0x00,
        0xa8, 0x00, 0xb9, 0x00, 0x0f, 0x00, 0x4e, 0x00, 0x39, 0x00, 0xcb, 0x00, 0xae, 0x00, 0xf3,
        0x00, 0xd2, 0x00, 0x03, 0x00, 0x30, 0x00, 0xec, 0x00, 0x7f, 0x00, 0x13, 0x00, 0x44, 0x00,
        0xda, 0x00, 0x74, 0x00, 0x6a, 0x00, 0x0c, 0x00, 0x8f, 0x00, 0x39, 0x00, 0x59, 0x00, 0xe1,
        0x00, 0xa1, 0x00, 0xc8, 0x00, 0x3a, 0x00, 0x6b, 0x00, 0xfa, 0x00, 0xe8, 0x00, 0xa1, 0x00,
        0xcc, 0x00, 0x6f, 0x00,
    ];
    ...
    let gen_63_19_data: [u8; 90] = [
        0x01, 0x00, 0x41, 0x00, 0x3a, 0x00, 0x5f, 0x00, 0x33, 0x00, 0x1e, 0x00, 0xad, 0x00, 0x1e,
        0x00, 0xa1, 0x00, 0xdb, 0x00, 0x07, 0x00, 0x11, 0x00, 0x01, 0x00, 0xdd, 0x00, 0x35, 0x00,
        0x7f, 0x00, 0x42, 0x00, 0x06, 0x00, 0x63, 0x00, 0x27, 0x00, 0xcd, 0x00, 0xea, 0x00, 0x20,
        0x00, 0xc2, 0x00, 0x44, 0x00, 0xfc, 0x00, 0xfe, 0x00, 0xd8, 0x00, 0x39, 0x00, 0x29, 0x00,
        0xa8, 0x00, 0x86, 0x00, 0x64, 0x00, 0xd6, 0x00, 0x3d, 0x00, 0xad, 0x00, 0xc4, 0x00, 0x58,
        0x00, 0xa6, 0x00, 0x1e, 0x00, 0xd7, 0x00, 0x39, 0x00, 0xa8, 0x00, 0xf8, 0x00, 0x24, 0x00,
    ];
    tables.insert("gen_63_19".to_string(), gen_63_19_data.to_vec());

    // Table gen_63_21 (86 bytes)
    let gen_63_21_data: [u8; 86] = [
        0x01, 0x00, 0xd8, 0x00, 0x1a, 0x00, 0x12, 0x00, 0xfb, 0x00, 0x60, 0x00, 0x8f, 0x00, 0xa8,
        0x00, 0x16, 0x00, 0x3a, 0x00, 0x87, 0x00, 0x2f, 0x00, 0x8e, 0x00, 0xfb, 0x00, 0xa7, 0x00,
        0x33, 0x00, 0x11, 0x00, 0x83, 0x00, 0x06, 0x00, 0xa6, 0x00, 0x66, 0x00, 0xed, 0x00, 0xe5,
        0x00, 0x94, 0x00, 0x72, 0x00, 0xc6, 0x00, 0xb9, 0x00, 0x85, 0x00, 0xd8, 0x00, 0x99, 0x00,
        0x5c, 0x00, 0xfa, 0x00, 0xf5, 0x00, 0x26, 0x00, 0x27, 0x00, 0xcb, 0x00, 0x73, 0x00, 0x51,
    ...
    let gen_63_23_data: [u8; 82] = [
        0x01, 0x00, 0xb9, 0x00, 0xc7, 0x00, 0xd3, 0x00, 0x91, 0x00, 0x04, 0x00, 0x0d, 0x00, 0xa9,
        0x00, 0xf2, 0x00, 0x9e, 0x00, 0xb3, 0x00, 0x08, 0x00, 0x2f, 0x00, 0xe3, 0x00, 0x5e, 0x00,
        0x6c, 0x00, 0xec, 0x00, 0x5e, 0x00, 0xee, 0x00, 0x53, 0x00, 0x32, 0x00, 0x83, 0x00, 0x66,
        0x00, 0x19, 0x00, 0xc0, 0x00, 0x1c, 0x00, 0x6f, 0x00, 0x51, 0x00, 0x2a, 0x00, 0xed, 0x00,
        0xbc, 0x00, 0x78, 0x00, 0x64, 0x00, 0xb7, 0x00, 0xfc, 0x00, 0x68, 0x00, 0x5d, 0x00, 0x13,
        0x00, 0xa3, 0x00, 0x89, 0x00, 0xa0, 0x00,
    ];
    tables.insert("gen_63_23".to_string(), gen_63_23_data.to_vec());

    // Table gen_63_25 (78 bytes)
    let gen_63_25_data: [u8; 78] = [
        0x01, 0x00, 0xe6, 0x00, 0x25, 0x00, 0xd4, 0x00, 0xf7, 0x00, 0xeb, 0x00, 0xbe, 0x00, 0x6c,
        0x00, 0x88, 0x00, 0x69, 0x00, 0x3d, 0x00, 0xdc, 0x00, 0xe3, 0x00, 0x27, 0x00, 0xf0, 0x00,
        0xb9, 0x00, 0xcc, 0x00, 0x5d, 0x00, 0x86, 0x00, 0x99, 0x00, 0x21, 0x00, 0xda, 0x00, 0xfa,
        0x00, 0xc3, 0x00, 0x5a, 0x00, 0xcd, 0x00, 0x32, 0x00, 0xfa, 0x00, 0x2f, 0x00, 0x19, 0x00,
        0xea, 0x00, 0x51, 0x00, 0xde, 0x00, 0x4c, 0x00, 0x14, 0x00, 0x72, 0x00, 0x57, 0x00, 0xaf,
        0x00, 0xf5, 0x00,
    ];
    ...
    let gen_63_27_data: [u8; 74] = [
        0x01, 0x00, 0x38, 0x00, 0x37, 0x00, 0x22, 0x00, 0xb4, 0x00, 0xdb, 0x00, 0x4a, 0x00, 0x47,
        0x00, 0xb0, 0x00, 0x2f, 0x00, 0xbf, 0x00, 0x66, 0x00, 0xcd, 0x00, 0x96, 0x00, 0x3f, 0x00,
        0x85, 0x00, 0x3a, 0x00, 0x01, 0x00, 0x33, 0x00, 0x4a, 0x00, 0xbb, 0x00, 0x16, 0x00, 0xd2,
        0x00, 0x67, 0x00, 0xfb, 0x00, 0x2e, 0x00, 0xe0, 0x00, 0x29, 0x00, 0x44, 0x00, 0x55, 0x00,
        0x48, 0x00, 0x52, 0x00, 0x18, 0x00, 0x9a, 0x00, 0xcd, 0x00, 0xbe, 0x00, 0xe4, 0x00,
    ];
    tables.insert("gen_63_27".to_string(), gen_63_27_data.to_vec());

    // Table gen_63_29 (70 bytes)
    let gen_63_29_data: [u8; 70] = [
        0x01, 0x00, 0x81, 0x00, 0xf0, 0x00, 0xa4, 0x00, 0x43, 0x00, 0xc0, 0x00, 0x0c, 0x00, 0x7c,
        0x00, 0x0c, 0x00, 0x3e, 0x00, 0x0d, 0x00, 0x97, 0x00, 0xa7, 0x00, 0x86, 0x00, 0x39, 0x00,
        0xab, 0x00, 0x15, 0x00, 0x0f, 0x00, 0xe3, 0x00, 0x1b, 0x00, 0x10, 0x00, 0x16, 0x00, 0x33,
        0x00, 0xf0, 0x00, 0x71, 0x00, 0x42, 0x00, 0x7f, 0x00, 0x59, 0x00, 0xd5, 0x00, 0xc8, 0x00,
        0x77, 0x00, 0x17, 0x00, 0x71, 0x00, 0xbf, 0x00, 0xd6, 0x00,
    ];
    tables.insert("gen_63_29".to_string(), gen_63_29_data.to_vec());

    // Table gen_63_31 (66 bytes)
    let gen_63_31_data: [u8; 66] = [
        0x01, 0x00, 0xe8, 0x00, 0x1d, 0x00, 0xbd, 0x00, 0x32, 0x00, 0x8e, 0x00, 0xf6, 0x00, 0xe8,
        0x00, 0x0f, 0x00, 0x2b, 0x00, 0x52, 0x00, 0xa4, 0x00, 0xee, 0x00, 0x01, 0x00, 0x9e, 0x00,
        0x0d, 0x00, 0x77, 0x00, 0x9e, 0x00, 0xe0, 0x00, 0x86, 0x00, 0xe3, 0x00, 0xd2, 0x00, 0xa3,
        0x00, 0x32, 0x00, 0x6b, 0x00, 0x28, 0x00, 0x1b, 0x00, 0x68, 0x00, 0xfd, 0x00, 0x18, 0x00,
        0xef, 0x00, 0xd8, 0x00, 0x2d, 0x00,
    ];
    ...
    let gen_63_59_data: [u8; 10] = [0x01, 0x00, 0x1e, 0x00, 0xd8, 0x00, 0xe7, 0x00, 0x74, 0x00];
    tables.insert("gen_63_59".to_string(), gen_63_59_data.to_vec());

    // Table gen_63_61 (6 bytes)
    let gen_63_61_data: [u8; 6] = [0x01, 0x00, 0x06, 0x00, 0x08, 0x00];
    ...
    let gen_127_123_data: [u8; 10] = [0x01, 0x00, 0x1e, 0x00, 0xd8, 0x00, 0xe7, 0x00, 0x74, 0x00];
    tables.insert("gen_127_123".to_string(), gen_127_123_data.to_vec());

    // Table gen_127_125 (6 bytes)
    let gen_127_125_data: [u8; 6] = [0x01, 0x00, 0x06, 0x00, 0x08, 0x00];
    ...
    let gen_255_251_data: [u8; 10] = [0x01, 0x00, 0x1e, 0x00, 0xd8, 0x00, 0xe7, 0x00, 0x74, 0x00];
    tables.insert("gen_255_251".to_string(), gen_255_251_data.to_vec());

    // Table gen_255_253 (6 bytes)
    let gen_255_253_data: [u8; 6] = [0x01, 0x00, 0x06, 0x00, 0x08, 0x00];
    ...
    let gen_7_4_1_data: [u8; 18] = [
        0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00,
        0x00, 0x01, 0x00,
    ];
    ...
    let gen_7_1_2_data: [u8; 34] = [
        0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01,
        0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x01, 0x00, 0x01, 0x00,
    ];
    ...
    let gen_7_1_3_data: [u8; 50] = [
        0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01,
        0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01,
    ...
    let gen_7_1_4_data: [u8; 66] = [
        0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00,
        0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00,
    ...
    let parity_check_7_4_data: [u8; 21] = [
        0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x01, 0x00, 0x00, 0x01, 0x01, 0x00,
        0x00, 0x00, 0x01, 0x01, 0x01, 0x01,
    ];
    tables.insert(
        "parity_check_7_4".to_string(),
        parity_check_7_4_data.to_vec(),
    );

    // Table syndrome_7_4 (42 bytes)
    let syndrome_7_4_data: [u8; 42] = [
        0x7b, 0x31, 0x3a, 0x20, 0x30, 0x2c, 0x20, 0x32, 0x3a, 0x20, 0x31, 0x2c, 0x20, 0x33, 0x3a,
        0x20, 0x32, 0x2c, 0x20, 0x34, 0x3a, 0x20, 0x33, 0x2c, 0x20, 0x35, 0x3a, 0x20, 0x34, 0x2c,
        0x20, 0x36, 0x3a, 0x20, 0x35, 0x2c, 0x20, 0x37, 0x3a, 0x20, 0x36, 0x7d,
    ];
    ...
    tables.insert(
        "parity_check_15_11".to_string(),
        parity_check_15_11_data.to_vec(),
    );
    ...
    tables.insert(
        "parity_check_31_26".to_string(),
        parity_check_31_26_data.to_vec(),
    );
    ...
    tables.insert(
        "parity_check_63_57".to_string(),
        parity_check_63_57_data.to_vec(),
    );
    ...
    tables.insert(
        "parity_check_127_120".to_string(),
        parity_check_127_120_data.to_vec(),
    );

    // Table syndrome_127_120 (1052 bytes)
    let syndrome_127_120_data = include_bytes!("tables/syndrome_127_120.bin");
    tables.insert(
        "syndrome_127_120".to_string(),
        syndrome_127_120_data.to_vec(),
    );

    // Table parity_check_255_247 (2040 bytes)
    let parity_check_255_247_data = include_bytes!("tables/parity_check_255_247.bin");
    tables.insert(
        "parity_check_255_247".to_string(),
        parity_check_255_247_data.to_vec(),
    );

    // Table syndrome_255_247 (2332 bytes)
    let syndrome_255_247_data = include_bytes!("tables/syndrome_255_247.bin");
    tables.insert(
        "syndrome_255_247".to_string(),
        syndrome_255_247_data.to_vec(),
    );

    // Table gen_1_3 (32 bytes)
    let gen_1_3_data: [u8; 32] = [
        0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00,
    ];
    ...
    let gen_1_4_data: [u8; 80] = [
        ...
        0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01,
    ...
    let gen_2_3_data: [u8; 56] = [
        0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    tables.insert(
        "interleaver_1000".to_string(),
        interleaver_1000_data.to_vec(),
    );

    // Table trellis_3_1_2 (32 bytes)
    let trellis_3_1_2_data: [u8; 32] = [
        0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x03, 0x00, 0x02, 0x00, 0x03, 0x00, 0x03, 0x00, 0x02,
        0x00, 0x00, 0x00, 0x02, 0x00, 0x01, 0x00, 0x01, 0x00, 0x02, 0x00, 0x01, 0x00, 0x03, 0x00,
        0x00, 0x00,
    ];
    ...
    let trellis_3_1_3_data: [u8; 32] = [
        0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x07, 0x00, 0x02, 0x00, 0x03, 0x00, 0x03, 0x00, 0x02,
        0x00, 0x00, 0x00, 0x06, 0x00, 0x01, 0x00, 0x05, 0x00, 0x02, 0x00, 0x01, 0x00, 0x03, 0x00,
        0x00, 0x00,
    ];
